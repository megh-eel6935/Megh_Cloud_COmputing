...
public class MeghIntentService extends IntentService {
     ...
     */
    public MeghIntentService(String name) {
...
/*
    ...
    static final String DISPLAY_MESSAGE_ACTION =
            "com.example.salman.DISPLAY_MESSAGE";
...
/**
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        Log.d("NAME", MainActivity.login_email.getText().toString());
        ServerUtilities.register(context, MainActivity.login_email.getText().toString(),

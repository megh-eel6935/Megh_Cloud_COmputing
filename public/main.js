    ...
    $('#publickey').text("publickey : " + getCookie("publickey"))
     ...
     $.get("/getmessages", function(data) {
        ...
        for (var i = 0; i < length; i++) {
            ...
            var timeline = "<li><div class=\"timeline-badge warning\"><i class=\"glyphicon glyphicon-envelope\"></i></div><div class=\"timeline-panel\">"
          +"<div class=\"timeline-heading\"><h4 class=\"timeline-title\">"+linkify(data.data[i].content)+"</h4><p><small class=\"text-muted\">"
          +"<i class=\"glyphicon glyphicon-time\"></i>"+timeConverter(data.data[i].timestamp)+"</small></p></div><div class=\"timeline-body\">"
          +"<p> shared from your android device</p></div></div></li>"

            } else if (data.data[i].content_type == "url") {
                // var temp = "<tr><td>" + linkify(data.data[i].content) + " <td> <td align='right'>url</td></tr>";
                var timeline = "<li><div class=\"timeline-badge info\"><i class=\"glyphicon glyphicon-link\"></i></div><div class=\"timeline-panel\">"
          +"<div class=\"timeline-heading\"><h4 class=\"timeline-title\">"+linkify(data.data[i].content)+"</h4><p><small class=\"text-muted\">"
          +"<i class=\"glyphicon glyphicon-time\"></i>"+timeConverter(data.data[i].timestamp)+"</small></p></div><div class=\"timeline-body\">"
          +"<p>shared from chrome</p></div></div></li>"
                ...
                var timeline = "<li><div class=\"timeline-badge danger\"><i class=\"glyphicon glyphicon-file\"></i></div><div class=\"timeline-panel\">"
          +"<div class=\"timeline-heading\"><h4 class=\"timeline-title\"><a href='https://s3-us-west-2.amazonaws.com/megh-uploads/"+data.data[i].content+"' class=\"glyphicon glyphicon-download-alt\">  </a> "+data.data[i].content+"</h4><p><small class=\"text-muted\">"
          +"<i class=\"glyphicon glyphicon-time\"></i>"+timeConverter(data.data[i].timestamp)+"</small></p></div><div class=\"timeline-body\">"
          +"<p>shared from browser</p></div></div></li>"
